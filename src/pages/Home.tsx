...
import { Building2, FileText, BarChart3, HelpCircle, MessageSquare, ArrowRight, Target, Users, Award, BookOpen, ChevronLeft, ChevronRight, AlertTriangle, Clock, CheckCircle2, XCircle, TrendingUp } from 'lucide-react';
        ...
        {banners.length > 0 ? (
          ...
          <section className="institutional-gradient py-16 px-4">
            <div className="max-w-4xl mx-auto text-center space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full bg-primary-foreground/10 px-5 py-2 text-sm font-medium text-primary-foreground">
